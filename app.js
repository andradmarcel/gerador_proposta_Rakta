    ...
    services: [
      {
        ...
        levels: {
          ...
          avancado: {
            ...
            priceRange: [3000, 4000],
            period: "mês",
            description: "Cobertura de 3 a 4 redes, mais de 20 posts por mês, publicação diária de stories, produção de 4 reels ou vídeos por mês, serviço de SAC social, gestão ativa de comunidade, relatórios semanais."
          }
        }
      },
      {
    ...
    services: [
      {
        ...
        levels: {
          ...
          intermediario: {
            ...
            price: 1200,
            period: "mês",
            description: "Gestão ativa de 2 a 3 funis comerciais, programação de réguas e automações de follow-up de vendas, integração de dados com 1 canal de comunicação (WhatsApp ou e-mail), relatório quinzenal."
          },
          avancado: {
            name: "Nível Avançado",
            price: 1900,
...
function calculateTotals() {
  ...
  let totalMonthly = autoMonthly;
  if (proposalState.overrideMonthly !== null && proposalState.overrideMonthly !== undefined && !isNaN(proposalState.overrideMonthly)) {
    totalMonthly = proposalState.overrideMonthly;
  } else if (proposalState.discountMonthly !== null && proposalState.discountMonthly !== undefined && !isNaN(proposalState.discountMonthly)) {
    totalMonthly = Math.max(0, autoMonthly - proposalState.discountMonthly);
  }

  let totalOneOffAndSetup = autoOneOffAndSetup;
  if (proposalState.overrideOneOffAndSetup !== null && proposalState.overrideOneOffAndSetup !== undefined && !isNaN(proposalState.overrideOneOffAndSetup)) {
    totalOneOffAndSetup = proposalState.overrideOneOffAndSetup;
  } else if (proposalState.discountOneOff !== null && proposalState.discountOneOff !== undefined && !isNaN(proposalState.discountOneOff)) {
    totalOneOffAndSetup = Math.max(0, autoOneOffAndSetup - proposalState.discountOneOff);
  }
